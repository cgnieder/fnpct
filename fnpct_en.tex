...
\begin{beschreibung}
 ...
 \option{after-dot-space}{<dim>} space to be inserted after a full stop and before the
 ...
 \option{punct-after}{\default{true}/false} when \code{true} the punctuation sign
 will be placed \emph{after} the footnote.
 \option{before-dot-space}{<dim>} space to be inserted before a full stop and after the
