% arara: pdflatex
% arara: makeindex: { sort: true, style: fnpct_en.ist }
% arara: biber
% arara: pdflatex
% arara: pdflatex
% --------------------------------------------------------------------------
...
\begin{beschreibung}
 ...
 \key{punct-after}{true}. Default = \code{-.16em}
 %
...
\begin{beschreibung}
 ...
 other two) will issue errors if the note command in question has already been
