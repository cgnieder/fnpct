...
but not inside another \cmd{innerfootnote}:
\begin{beschreibung}
 \befehl{innerfootnote}*[<mark>]{<text>} a nested footnote.
\end{beschreibung}
...
\begin{figure}[h]
 ...
 \caption{\cmd{innerfootnote} example (a)}\label{fig:nested:a}
\end{figure}
...
\begin{document}
  ...
  out of straw\footnote{not to be confused with hay},
  sticks\footnote{or lumber according to some sources}
  and bricks\footnote{probably\innerfootnote{just guessing}
  fired clay bricks\innerfootnote{or not}}.
\end{document}
\end{beispiel}
...
\begin{figure}[h]
 ...
 \caption{\cmd{innerfootnote} example (b)}\label{fig:nested:b}
\end{figure}

\cmd{innerfootnote} can also be used to escape minipages. In this case use
\cmd{innerfootnote} as a replacement for \cmd{footnote} and call this command
later:
\begin{beschreibung}
...
\begin{minipage}{.9\linewidth}
 ...
 out of straw\innerfootnote{not to be confused with hay},
 sticks\innerfootnote{or lumber according to some sources}
 and bricks\innerfootnote{probably}.
...
\begin{figure}[h]
 ...
 \caption{\cmd{innerfootnote} example (c)}\label{fig:nested:c}
\end{figure}
