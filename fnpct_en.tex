...
\subsection{fixfoot}
The \paket{fixfoot} \cite{fixfoot} package provides possibility to create repeating footnotes.
\fnpct supports this package provided you take care of the following:
\begin{itemize}
