...
if you place the \cmd{footnote} command after a dot or a comma it is treated as if
...
\newpage
\section{Other notes}
\fnpct currently supports two packages which provide similar notes.
\subsection{endnotes}\secidx{endnotes}
The \paket{endnotes} package povides the commands \cmd{endnote} and \cmd{endnotemark}
...
The \paket{parnotes} package does something similar to the \paket{endnotes}
